...
describe("setup-ghcli.ts", () => {
  ...
  test("downloadUrl() - when linux + x64, return amd64", () => {
    jest.spyOn(os, "type").mockImplementation(() => {return 'Linux'});
    
    const expectedUrl = 'https://github.com/cli/cli/releases/download/v2.28.0/gh_2.28.0_linux_amd64.tar.gz';
  ...
  test("downloadUrl() - when linux + arm64, return arm64", () => {
    ...
    const expectedUrl = 'https://github.com/cli/cli/releases/download/v2.28.0/gh_2.28.0_linux_arm64.tar.gz';
  ...
  test("downloadUrl() - when darwin + x64, return amd64", () => {
    jest.spyOn(os, "type").mockImplementation(() => {return 'Darwin'});
    
    const expectedUrl = 'https://github.com/cli/cli/releases/download/v2.28.0/gh_2.28.0_macOS_amd64.zip';
    const actualUrl = downloadUrl("2.28.0", "x64");
  ...
  test("downloadUrl() - when darwin + amd, return arm64", () => {
    ...
    const expectedUrl = 'https://github.com/cli/cli/releases/download/v2.28.0/gh_2.28.0_macOS_arm64.zip';
    const actualUrl = downloadUrl("2.28.0", "arm64");
  ...
  test("downloadUrl() - when windows + x64, return amd64", () => {
    jest.spyOn(os, "type").mockImplementation(() => {return 'Windows_NT'});
    
    const expectedUrl = 'https://github.com/cli/cli/releases/download/v2.28.0/gh_2.28.0_windows_amd64.zip';
    const actualUrl = downloadUrl("2.28.0", "x64");
  ...
  test("downloadUrl() - when windows + arm64, return arm64", () => {
    ...
    const expectedUrl = 'https://github.com/cli/cli/releases/download/v2.28.0/gh_2.28.0_windows_arm64.zip';
    const actualUrl = downloadUrl("2.28.0", "arm64");
